...
NSString *const MJRefreshFooterPullToRefresh = @"上拉载入更多";
NSString *const MJRefreshFooterReleaseToRefresh = @"松开载入更多";
NSString *const MJRefreshFooterRefreshing = @"正在载入更多...";
