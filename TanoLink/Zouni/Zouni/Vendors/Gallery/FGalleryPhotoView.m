...
- (id)initWithFrame:(CGRect)frame
{
    ...
    UILongPressGestureRecognizer *longPressSave = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(longPressSavaImage:)];
    [self addGestureRecognizer:longPressSave];
...
-(void) longPressSavaImage:(UILongPressGestureRecognizer *)longPress{
    if (longPress.state == UIGestureRecognizerStateBegan) {
        UIAlertView *showSave = [[UIAlertView alloc]initWithTitle:@"保存到手机？" message:@"" delegate:self cancelButtonTitle:@"保存" otherButtonTitles:@"取消", nil];
