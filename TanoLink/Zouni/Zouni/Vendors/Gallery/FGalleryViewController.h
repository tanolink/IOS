...
@interface FGalleryViewController : ZNBaseViewController <UIScrollViewDelegate,FGalleryPhotoDelegate,FGalleryPhotoViewDelegate> {
	...
	UILabel *_caption;
    UILabel *_captionOfCurrPageNum; // current page number
    UILabel *_captionOfTotalCount; // total count
 ...
 *  点赞动画
 */
@property (nonatomic,strong)  UILabel *labPraise;
/**
 *  是否点赞
 */
@property (nonatomic,assign) BOOL _isPraise;
/**
 *  是否收藏
 */
@property (nonatomic,assign) BOOL _isFavorite;
