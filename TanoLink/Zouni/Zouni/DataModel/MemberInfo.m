...
NSString *const kuserUserPhotoId = @"userPhotoId";
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.userPhotoId = [aDecoder decodeObjectForKey:kuserUserPhotoId];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_userPhotoId forKey:kuserUserPhotoId];
