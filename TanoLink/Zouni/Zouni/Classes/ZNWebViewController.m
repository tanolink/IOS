...
#import "ZNWebViewController.h"
#import "ZNAppUtil.h"

@interface ZNWebViewController ()
...
@implementation ZNWebViewController {
...
- (void)loadView {
    ...
    [_webView.scrollView setContentInset:UIEdgeInsetsMake(1 , 0, 0, 0)];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    if (titleFromHTML!=nil && ![titleFromHTML isEqualToString:@""])
        [self setNavTitle:titleFromHTML];*/
